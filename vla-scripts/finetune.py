...
class FinetuneConfig:
    ...
    run_root_dir: Path = Path("runs_raw_data")                               # Path to directory to store logs & checkpoints
    adapter_tmp_dir: Path = Path("adapter-tmp-raw-data")                     # Temporary directory for LoRA weights before fusing
